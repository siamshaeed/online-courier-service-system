        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="mainNavBody">
            <ul class="nav navbar-nav right-nav">
                ...
                <li><a href="user-registration-page.php">Registration</a></li>
...
<?php } else{?> 
                  <li><a href="user-login.php"><i style="padding-right: 5px;" class="fa fa-lock" aria-hidden="true"></i>
User login</a></li>
                  <li><a href="cuirer-login.php"><i style="padding-right: 5px;" class="fa fa-lock" aria-hidden="true"></i>
Cuirer Login</a></li>
                  <li><a href="admin-login.php"><i style="padding-right: 5px;" class="fa fa-lock" aria-hidden="true"></i>
Admin-login</a></li> 
<?php }?>                                  
                </ul>
              </li>
